...
const renderColorsChart = (colorsCtx, tasks) => {
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_4___default.a(colorsCtx, {
...
const renderDaysChart = (daysCtx, tasks, dateFrom, dateTo) => {
  ...
  const formattedDates = days.map((it) => moment__WEBPACK_IMPORTED_MODULE_3___default()(it).format(`DD MMM`));

  return new chart_js__WEBPACK_IMPORTED_MODULE_4___default.a(daysCtx, {
    plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_5___default.a],
    type: `line`,
    data: {
...
const renderTagsChart = (tagsCtx, tasks) => {
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_4___default.a(tagsCtx, {
    plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_5___default.a],
    type: `pie`,
    data: {
      labels: tagsLabels,
...
const createPlaceholder = (dateFrom, dateTo) => {
  const format = (date) => {
    return moment__WEBPACK_IMPORTED_MODULE_3___default()(date).format(`DD MMM`);
  };
...
class Statistics extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _applyFlatpickr(element) {
    ...
    this._flatpickr = flatpickr__WEBPACK_IMPORTED_MODULE_2___default()(element, {
      altInput: true,
      allowInput: true,
...
const createTaskEditTemplate = (task, options = {}) => {
  ...
  const description = he__WEBPACK_IMPORTED_MODULE_1___default.a.encode(currentDescription);
  const isExpired = dueDate instanceof Date && Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_4__["isOverdueDate"])(dueDate, new Date());
  const isBlockSaveButton = (isDateShowing && isRepeatingTask) ||
    (isRepeatingTask && !isRepeating(activeRepeatingDays)) ||
    !isAllowableDescriptionLength(description);

  const date = (isDateShowing && dueDate) ? Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_4__["formatDate"])(dueDate) : ``;
  const time = (isDateShowing && dueDate) ? Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_4__["formatTime"])(dueDate) : ``;

  const repeatClass = isRepeatingTask ? `card--repeat` : ``;
  const deadlineClass = isExpired ? `card--deadline` : ``;

  const tagsMarkup = createHashtags(tags);
  const colorsMarkup = createColorsMarkup(_constants_js__WEBPACK_IMPORTED_MODULE_3__["COLORS"], color);
  const repeatingDaysMarkup = createRepeatingDaysMarkup(_constants_js__WEBPACK_IMPORTED_MODULE_3__["DAYS"], activeRepeatingDays);
...
const parseFormData = (formData) => {
  const repeatingDays = _constants_js__WEBPACK_IMPORTED_MODULE_3__["DAYS"].reduce((acc, day) => {
    acc[day] = false;
    return acc;
  }, {});
...
/***/ "./src/components/tasks-container.js":
/*!*******************************************!*\
  !*** ./src/components/tasks-container.js ***!
  \*******************************************/
/*! exports provided: default */
...
class TasksContainer extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/*!**************************!*\
  !*** ./src/constants.js ***!
  \**************************/
/*! exports provided: COLOR, COLORS, DAYS, MONTH_NAMES, ESC_KEYCODE, FilterType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _components_tasks_container_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/tasks-container.js */ "./src/components/tasks-container.js");
...
/* harmony import */ var _components_load_more_btn_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/load-more-btn.js */ "./src/components/load-more-btn.js");
...
const renderTasks = (taskListElement, tasks, onDataChange, onViewChange) => {
  return tasks.map((task) => {
    const taskController = new _task_js__WEBPACK_IMPORTED_MODULE_5__["default"](taskListElement, onDataChange, onViewChange);
    taskController.render(task, _task_js__WEBPACK_IMPORTED_MODULE_5__["Mode"].DEFAULT);
...
class BoardController {
  constructor(container, tasksModel) {
    ...
    this._tasksContainerComponent = new _components_tasks_container_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._loadMoreButtonComponent = new _components_load_more_btn_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
  ...
  render() {
    ...
    if (isAllTasksArchived) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(container, this._noTasksComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
      return;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(container, this._sortComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(container, this._tasksContainerComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
  ...
  createTask() {
    ...
    const taskList = this._tasksContainerComponent.getElement();
    this._creatingTask = new _task_js__WEBPACK_IMPORTED_MODULE_5__["default"](taskList, this._onDataChange, this._onViewChange);
    this._creatingTask.render(_task_js__WEBPACK_IMPORTED_MODULE_5__["EmptyTask"], _task_js__WEBPACK_IMPORTED_MODULE_5__["Mode"].ADDING);
  }
  ...
  _renderLoadMoreButton() {
    ...
    const container = this._container.getElement();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(container, this._loadMoreButtonComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);

    this._loadMoreButtonComponent.setClickHandler(this._onLoadMoreButtonClick);
  }

  _onDataChange(taskController, oldData, newData) {
    if (oldData === _task_js__WEBPACK_IMPORTED_MODULE_5__["EmptyTask"]) {
      this._creatingTask = null;
      if (newData === null) {
        ...
        taskController.render(newData, _task_js__WEBPACK_IMPORTED_MODULE_5__["Mode"].DEFAULT);
  ...
  _onSortTypeChange(sortType) {
    ...
    switch (sortType) {
      case _components_sort_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DATE_UP:
        sortedTasks = tasks.slice().sort((a, b) => a.dueDate - b.dueDate);
        break;
      case _components_sort_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DATE_DOWN:
        sortedTasks = tasks.slice().sort((a, b) => b.dueDate - a.dueDate);
        break;
      case _components_sort_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT:
    ...
    if (sortType === _components_sort_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT) {
      this._renderLoadMoreButton();
    } else {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._loadMoreButtonComponent);
    }
...
/* harmony import */ var _components_site_filter_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/site-filter.js */ "./src/components/site-filter.js");
...
class FilterController {
  constructor(container, tasksModel) {
    ...
    this._activeFilterType = _constants_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL;
  ...
  render() {
    ...
    const filters = Object.values(_constants_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"]).map((filterType) => {
      return {
        name: filterType,
    ...
    this._filterComponent = new _components_site_filter_js__WEBPACK_IMPORTED_MODULE_0__["default"](filters);
...
/* harmony import */ var _components_task_edit_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/task-edit.js */ "./src/components/task-edit.js");
...
const EmptyTask = {
  ...
  tags: [],
  color: _constants_js__WEBPACK_IMPORTED_MODULE_2__["COLOR"].BLACK,
  isFavorite: false,
  isArchive: false,
};
...
class TaskController {
  ...
  render(task, mode) {
    ...
    this._taskEditComponent = new _components_task_edit_js__WEBPACK_IMPORTED_MODULE_0__["default"](task);
  ...
  _onEscPress(evt) {
    if (evt.keyCode === _constants_js__WEBPACK_IMPORTED_MODULE_2__["ESC_KEYCODE"]) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _mock_task_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mock/task.js */ "./src/mock/task.js");
...
/* harmony import */ var _models_tasks_model_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./models/tasks-model.js */ "./src/models/tasks-model.js");
...
const siteMenuComponent = new _components_site_menu_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
// const statisticsComponent = new StatisticsComponent();

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(siteControlElement, siteMenuComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
const tasksModel = new _models_tasks_model_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
tasksModel.setTasks(_mock_task_js__WEBPACK_IMPORTED_MODULE_0__["tasks"]);
...
const statisticsComponent = new _components_statistics_js__WEBPACK_IMPORTED_MODULE_4__["default"]({tasks: tasksModel, dateFrom, dateTo});

const filterController = new _controllers_filter_js__WEBPACK_IMPORTED_MODULE_6__["default"](siteMainElement, tasksModel);
filterController.render();

const boardComponent = new _components_board_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(siteMainElement, boardComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(siteMainElement, statisticsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);

const boardController = new _controllers_board_js__WEBPACK_IMPORTED_MODULE_3__["default"](boardComponent, tasksModel);
statisticsComponent.hide();
boardController.render();

siteMenuComponent.setOnChange((menuItem) => {
  switch (menuItem) {
    case _components_site_menu_js__WEBPACK_IMPORTED_MODULE_7__["MenuItem"].NEW_TASK:
      siteMenuComponent.setActiveItem(_components_site_menu_js__WEBPACK_IMPORTED_MODULE_7__["MenuItem"].TASKS);
      statisticsComponent.hide();
      boardController.show();
      boardController.createTask();
      break;
    case _components_site_menu_js__WEBPACK_IMPORTED_MODULE_7__["MenuItem"].STATISTICS:
      boardController.hide();
      statisticsComponent.show();
      break;
    case _components_site_menu_js__WEBPACK_IMPORTED_MODULE_7__["MenuItem"].TASKS:
      statisticsComponent.hide();
      boardController.show();
      break;
  }
...
const generateTask = () => {
  ...
  return {
    ...
    color: getRandomArrayItem(_constants_js__WEBPACK_IMPORTED_MODULE_0__["COLORS"]),
...
const getTasksByFilter = (tasks, filterType) => {
  ...
  switch (filterType) {
    case _constants_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL:
      return getNotArchiveTasks(tasks);
    case _constants_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ARCHIVE:
      return getArchiveTasks(tasks);
    case _constants_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].FAVORITES:
      return getFavoriteTasks(getNotArchiveTasks(tasks));
    case _constants_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].OVERDUE:
      return getOverdueTasks(getNotArchiveTasks(tasks), nowDate);
    case _constants_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].REPEATING:
      return getRepeatingTasks(getNotArchiveTasks(tasks));
    case _constants_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].TAGS:
      return getTasksWithHashtags(getNotArchiveTasks(tasks));
    case _constants_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].TODAY:
